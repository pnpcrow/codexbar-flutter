...
/// StepFun API fetch strategy using STEPFUN_TOKEN.
class StepFunFetchStrategy extends GenericAPIStrategy {
  StepFunFetchStrategy()
      : super(
          id: 'stepfun.api',
          provider: UsageProvider.stepfun,
          envVarName: 'STEPFUN_TOKEN',
          apiEndpoint: 'https://api.stepfun.com/v1/usage',
  ...
  static UsageSnapshot _parseResponse(Map<String, dynamic> json) {
    ...
    return UsageSnapshot(
      ...
      identity: const ProviderIdentitySnapshot(
        providerID: UsageProvider.stepfun,
        loginMethod: 'api-key',
      ),
    );
  }
